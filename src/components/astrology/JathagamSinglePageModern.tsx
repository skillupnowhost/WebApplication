...
/** Condensed single-A4-page Jathagam, MODERN premium style — indigo/violet palette, gradient-rim
 * cards and icon-led sections. Same data/sections as JathagamSinglePage (traditional). */
export function JathagamSinglePageModern({ view }: { view: ReportView }) {
  ...
  return (
    <>
      ...
      <ReportSection title={`${l("personal", lang)} · ${l("birthDetails", lang)}`} sectionKey="personal" style="MODERN" lang={lang} onepage>
        <div className="jd-card jd-soft grid grid-cols-3 gap-x-3 gap-y-1.5 p-2 sm:grid-cols-4">
          <ReportField style="MODERN" lang={lang} label={l("name", lang)} value={view.fullName} />
          <ReportField style="MODERN" lang={lang} label={l("gender", lang)} value={view.gender ? lv(lang, cap(view.gender)) : "—"} />
          <ReportField style="MODERN" lang={lang} label={l("dob", lang)} value={birthLocal.toFormat("dd MMM yyyy")} />
          <ReportField style="MODERN" lang={lang} label={l("tob", lang)} value={view.birthTimeKnown ? birthLocal.toFormat("hh:mm a") : lv(lang, "Unknown (12:00 assumed)")} />
          <ReportField style="MODERN" lang={lang} label={l("place", lang)} value={view.birthPlace} />
          <ReportField style="MODERN" lang={lang} label={l("systemL", lang)} value={AYANAMSA_NAMES[view.system]} />
          <ReportField style="MODERN" lang={lang} label={l("janmaRasi", lang)} value={rashiLabel(moon.rashi.index, lang)} />
          <ReportField style="MODERN" lang={lang} label={l("nakPada", lang)} value={`${nakshatraLabel(moon.nakshatra, lang)} · ${moon.nakshatra.pada}`} />
          <ReportField style="MODERN" lang={lang} label={l("lagnaAsc", lang)} value={rashiLabel(view.ascendant.rashi.index, lang)} />
          <ReportField style="MODERN" lang={lang} label={l("sunSign", lang)} value={rashiLabel(sun.rashi.index, lang)} />
          <ReportField style="MODERN" lang={lang} label={l("ganaL", lang)} value={lv(lang, view.avakahada.gana)} />
          <ReportField style="MODERN" lang={lang} label={l("nadiL", lang)} value={lv(lang, view.avakahada.nadi)} />
        </div>
      </ReportSection>

      {/* ---- Charts ---- */}
      <ReportSection title={l("charts", lang)} sectionKey="charts" style="MODERN" lang={lang} onepage className="jd-charts">
      ...
      {/* ---- Planetary positions ---- */}
      <ReportSection title={l("planetary", lang)} sectionKey="planetary" style="MODERN" lang={lang} onepage>
      ...
      <div className="grid grid-cols-2 gap-3">
        <ReportSection title={l("dasha", lang)} sectionKey="dasha" style="MODERN" lang={lang} onepage>
        ...
        <ReportSection title={l("upagrahaL", lang)} sectionKey="upagrahaL" style="MODERN" lang={lang} onepage>
          <div className="jd-card p-2">
      ...
      {/* ---- Lucky essentials ---- */}
      <ReportSection title={l("lucky", lang)} sectionKey="lucky" style="MODERN" lang={lang} onepage>
        <div className="jd-card jd-soft grid grid-cols-4 gap-x-3 gap-y-2 p-2.5">
          <ReportField style="MODERN" lang={lang} label={l("luckyNumbers", lang)} value={view.lucky.numbers.slice(0, 5).join(", ")} />
          <ReportField style="MODERN" lang={lang} label={l("luckyColour", lang)} value={lv(lang, view.numerology.luckyColor)} />
          <ReportField style="MODERN" lang={lang} label={l("luckyDay", lang)} value={lv(lang, view.lucky.day)} />
          <ReportField style="MODERN" lang={lang} label={l("deityL", lang)} value={lv(lang, view.lucky.deity)} />
        </div>
      </ReportSection>

      {/* ---- Narrative headline ---- */}
      {view.narrative.headline && (
        <ReportSection title={l("summary", lang)} sectionKey="summary" style="MODERN" lang={lang} onepage className="mb-1.5">
