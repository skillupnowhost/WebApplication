...
import { CONTACT_EMAILS, CONTACT_PHONES, WHATSAPP_PHONE, CONTACT_HOURS, SOCIAL_LINKS } from "@/lib/contactInfo";
        ...
        <div className="mt-16 grid grid-cols-1 gap-12 sm:mt-20 lg:grid-cols-5">
          <div className="lg:col-span-3">
            <RevealGroup className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
              {contactPoints.map((c) => (
                <RevealItem key={c.title} className={c.featured ? "sm:col-span-2 lg:col-span-3" : ""}>
                  <Card
